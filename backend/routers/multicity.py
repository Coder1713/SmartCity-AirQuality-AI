...
CITY_PROFILES = {
    "Delhi": {
        "stations": 38, "avg_aqi_2024": 218,
        "worst_months": ["October", "November", "December", "January"],
        "primary_sources": ["Vehicular Traffic", "Construction", "Biomass Burning"],
        "population_million": 32.9, "lat": 28.6139, "lon": 77.2090,
        "caaqms_count": 40, "days_poor_or_worse_2024": 203
    },
    "Mumbai": {
        "stations": 10, "avg_aqi_2024": 145,
        "worst_months": ["November", "December", "January"],
        "primary_sources": ["Vehicular Traffic", "Industrial Emissions", "Sea Salt"],
        "population_million": 20.7, "lat": 19.0760, "lon": 72.8777,
        "caaqms_count": 15, "days_poor_or_worse_2024": 61
    },
    "Kolkata": {
        "stations": 8, "avg_aqi_2024": 156,
        "worst_months": ["November", "December", "January", "February"],
        "primary_sources": ["Vehicular Traffic", "Biomass Burning", "Industrial Emissions"],
        "population_million": 14.8, "lat": 22.5726, "lon": 88.3639,
        "caaqms_count": 16, "days_poor_or_worse_2024": 98
    },
    "Bengaluru": {
        "stations": 7, "avg_aqi_2024": 98,
        "worst_months": ["January", "February", "March"],
        "primary_sources": ["Vehicular Traffic", "Construction"],
        "population_million": 13.2, "lat": 12.9716, "lon": 77.5946,
        "caaqms_count": 12, "days_poor_or_worse_2024": 28
    },
    "Chennai": {
        "stations": 6, "avg_aqi_2024": 89,
        "worst_months": ["January", "February"],
        "primary_sources": ["Vehicular Traffic", "Industrial Emissions"],
        "population_million": 11.5, "lat": 13.0827, "lon": 80.2707,
        "caaqms_count": 10, "days_poor_or_worse_2024": 19
    }
}
...
def score_intervention_readiness(city: str, profile: dict) -> dict:
    ...
    return {"readiness_score": min(score, 100), "factors": factors}
...
def get_city_overview():
    ...
    for city, profile in CITY_PROFILES.items():
        ...
        cities.append({
            ...
            "category": get_aqi_category(profile["avg_aqi_2024"]),
    ...
    return {
        "comparison": {
            city1: {
                ...
                "category": get_aqi_category(p1["avg_aqi_2024"]),
            ...
            city2: {
                ...
                "category": get_aqi_category(p2["avg_aqi_2024"]),
